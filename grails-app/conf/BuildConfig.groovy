	...
	dependencies {
		...
		compile "org.drools:drools-compiler:$droolsVersion", {
			excludes 'activation', 'antlr-runtime', 'cdi-api', 'drools-core', 'ecj', 'glazedlists_java15',
			         ...
			         'org.osgi.compendium', 'org.osgi.core', 'quartz', 'slf4j-api',    // 'protobuf-java',
		...
		compile "org.drools:drools-core:$droolsVersion", {
			excludes 'activation', 'antlr', 'antlr-runtime', 'cdi-api', 'junit', 'kie-api', 'kie-internal',
			         ...
			         'slf4j-api', 'stax-api', 'xstream'    // 'protobuf-java',
		}
		...
		runtime "org.codehaus.janino:janino:2.5.16", {    // Tried  2.7.6
			excludes 'ant-nodeps', 'junit'                // java.lang.NoClassDefFoundError: org/codehaus/janino/Scanner$ScanException
		}
